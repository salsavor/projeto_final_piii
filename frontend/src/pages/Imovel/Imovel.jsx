...
const propertyData = {
  ...
  `,
  images: [
    'https://images.unsplash.com/photo-1580582932707-52c50ae0e7a0?auto=format&fit=crop&q=80&w=2940&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    'https://images.unsplash.com/photo-1570129476813-f92a106b122c?auto=format&fit=crop&q=80&w=2940&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={4}>
          <Box sx={{ position: 'sticky', top: 20, left: 100, /* Ajuste para o padding do header, se houver */ }}>
            {/* Cartão do Agente */}
